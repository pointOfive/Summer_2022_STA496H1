...
7. **Intermediate Objective**: special presentation targetting David Duvenaud, Murat Erdogdu, Nathan Taback (outgoing DoSS Director of DS, incoming DoSS Associate Chair of UG Studies), Scott Schwartz (incoming DoSS Director of DS), and Radu Craiu (outgoing DoSS Chair).
